...
// // Zustand Stores (Assuming these paths are correct)
...
// // Types (Assuming these paths are correct)
...
//   DialogDescription,
//   DialogFooter,
//   DialogClose, // Import DialogClose for better closing behavior
...
//   const [isCommentDialogOpen, setIsCommentDialogOpen] = useState(false); // Control dialog state

//   // Filter comments specific to this blog post
...
//       setBlog((prevBlog) => prevBlog ? { ...prevBlog, isFavorite: false } : null); // Safer state update
//     } else {
...
//         image: blog.image,
//         title: blog.title,
//         content: blog.content, // Consider if full content is needed in favorite object
//         auther: blog.auther,
//         date: blog.date,
//       };
//       addFavBlog(newFav);
//       toast.success("Added to favorites");
//       setBlog((prevBlog) => prevBlog ? { ...prevBlog, isFavorite: true } : null); // Safer state update
//     }
//   };
...
//       blogid: blog.id,
//       username: user.username,
//       // Add user avatar if available in your user object
...
//         <div>
//           <h1 className="text-2xl font-semibold text-destructive mb-4">Blog Post Not Found</h1>
//           <p className="text-muted-foreground">
//             The blog post you are looking for does not exist or may have been removed.
//           </p>
//           {/* Optional: Add a button to go back or to the blog list */}
//           {/* <Button variant="outline" className="mt-6" onClick={() => router.push('/blog')}>Go to Blog List</Button> */}
//         </div>
//       </div>
//     );
//   }
...
//       <div className="container mx-auto px-4 py-8 min-h-screen">
//         <Card className="mb-12 shadow-lg overflow-hidden"> {/* Added shadow & overflow hidden */}
//           <CardHeader className="p-0"> {/* Remove padding for full-width image */}
//             <Image
//               src={blog.image}
//               alt={blog.title}
//               width={1200} // Larger width for container
//               height={600} // Adjust height as needed
//               className="w-full h-72 md:h-96 object-cover" // Responsive height
...
//                          aria-label={blog.isFavorite ? "Remove from favorites" : "Add to favorites"}
//                          className="text-red-500 hover:bg-red-100 dark:hover:bg-red-900/20 rounded-full cursor-pointer" // Added hover & rounded
//                        >
//                          {blog.isFavorite ? (
//                            <MdFavorite className="h-6 w-6 " /> // Consistent sizing
//                          ) : (
//                            <MdFavoriteBorder className="h-6 w-6" /> // Consistent sizing
//                          )}
//                        </Button>
//                     </TooltipTrigger>
//                     <TooltipContent>
//                       <p>{blog.isFavorite ? "Remove from favorites" : "Add to favorites"}</p>
//                     </TooltipContent>
//                  </Tooltip>
...
//                             <Button variant="ghost" size="icon" aria-label="Add comment" className="text-blue-500 hover:bg-blue-100 dark:hover:bg-blue-900/20 rounded-full cursor-pointer"> {/* Added hover & rounded */}
//                                 <BiSolidCommentDetail className="h-6 w-6" /> {/* Consistent sizing */}
//                             </Button>
//                         </DialogTrigger>
//                     </TooltipTrigger>
//                     <TooltipContent>
...
//                       <DialogDescription>
//                         Share your thoughts on {blog.title}. Click post when youre done.
//                       </DialogDescription>
//                     </DialogHeader>
...
//                       </DialogClose>
//                       <Button type="button" onClick={handleAddComment} disabled={!comment.trim()} className="cursor-pointer">Post Comment</Button>
//                     </DialogFooter>
//                   </DialogContent>
//                 </Dialog>
//               </div>
...
//             {/* Blog Content */}
//             {/* Use prose for styling, adjust max-width if needed */}
//             <div className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none text-foreground/90">
//               {/* Using whitespace-pre-wrap to respect newlines/spaces */}
...
//           <CardHeader>
//             <CardTitle className="text-2xl font-semibold">Comments ({blogComments.length})</CardTitle>
//             <CardDescription>See what others are saying.</CardDescription>
//           </CardHeader>
//           <CardContent className="space-y-6">
//             {blogComments.length > 0 ? (
//               blogComments.map((comment) => (
//                 <div key={comment.id} className="flex gap-4 border-b pb-4 last:border-b-0 last:pb-0">
//                   <Avatar className="h-10 w-10 border">
//                     {/* Optional: Add AvatarImage if you store user avatars */}
...
//                             · {new Date(comment.date).toLocaleString("en-US", { dateStyle: 'short', timeStyle: 'short' })}
//                           </span>
//                        </div>
...
//                                     <Button variant="ghost" size="icon" className="h-7 w-7 text-destructive/70 hover:text-destructive hover:bg-destructive/10 rounded-full cursor-pointer">
...
//                                 className="bg-destructive hover:bg-destructive/90 cursor-pointer" // Use destructive color
//                               >
//                                 Delete
//                               </AlertDialogAction>
//                             </AlertDialogFooter>
...
//                       )}
//                     </div>
//                     <p className="text-sm text-foreground/80 whitespace-pre-wrap"> {/* Keep pre-wrap for comment formatting */}
//                       {comment.content}
//                     </p>
//                   </div>
//                 </div>
...
//             )}
//           </CardContent>
//           {/* Optional: Add CardFooter if needed, e.g., for pagination */}
//         </Card>
//       </div>
//     </TooltipProvider>
//   );
